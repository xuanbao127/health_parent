...
public class SMSUtils {
	public static final String VALIDATE_CODE = "SMS_203191175";//发送短信验证码模板编码  模版CODE
	public static final String ORDER_NOTICE = "SMS_159771588";//体检预约成功通知
	private static final String SIGN_NAEM = "ABC商城";// 短信的签名
	private static final String PARAMETER_NAME="code";
	private static final String ACCESS_KEY="LTAI4GBtkvtm2cUxkKzztsBs"; //你的AccessKey ID
	private static final String SECRET_KEY="ElEuaQ9JWLxv1UMgUdjekmtEqyn9Fc"; //你的AccessKey Secret

	public static void main(String[] args) throws ClientException {
		SMSUtils.sendShortMessage(VALIDATE_CODE,"18512858679","999999");
	}
