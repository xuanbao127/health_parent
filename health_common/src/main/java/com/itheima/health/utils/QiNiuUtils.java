...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "rRjdl2ajcPTbbxSPmA7SCGG6eVuZiLDA8M4XuWoc";
    private static final String SECRETKEY = "xxyqT8UbbuF6GDYmHQF4iyBnP77HF-dwegNj9OcE";
    private static final String BUCKET = "czbk9";
    public static final String DOMAIN= "http://qh27d9yyh.hn-bkt.clouddn.com/";
